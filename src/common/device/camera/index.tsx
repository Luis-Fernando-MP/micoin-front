 ...
 *
 * @param options - Tipos de barcode admitidos
 *
 * @example
 * import { openScanner } from '@device/camera'
...
/**
 * CameraHost — host modal de cámara, video y escáner de códigos.
 *
 * Montar una vez en el root; el resto de la app usa `openCamera` / `openScanner`.
 *
 * @example
...
export { openCamera, openScanner, pickImage }
