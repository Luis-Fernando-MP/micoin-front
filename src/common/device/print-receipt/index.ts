...
/**
 * buildReceiptHtml — Genera HTML de comprobante para impresión.
 *
 * @example
 * import { buildReceiptHtml } from '@device/print-receipt'
...
/**
 * printAndShareReceipt — Imprime comprobante a PDF y lo comparte.
 *
 * @example
 * import { printAndShareReceipt } from '@device/print-receipt'
 * await printAndShareReceipt()
 */
